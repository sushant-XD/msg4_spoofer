...
/**
 * @brief NR PBCH payload size generated by higher layers, deduced from
 * TS 38.331 MIB description
 */
#define SRSRAN_PBCH_MSG_NR_SZ 24

/**
 * @brief Define the payload buffer for SRSRAN_PBCH_MSG_NR_SZ to be 32 for
 * alignment purposes
 */
...
typedef struct SRSRAN_API {
  uint8_t payload[SRSRAN_PBCH_MSG_NR_MAX_SZ]; ///< Actual PBCH payload provided
                                              ///< by higher layers
...
SRSRAN_API int srsran_pbch_msg_nr_mib_pack(const srsran_mib_nr_t *mib,
                                           srsran_pbch_msg_nr_t *msg);

SRSRAN_API int
srsran_pbch_msg_nr_mib_unpack(const srsran_pbch_msg_nr_t *pbch_msg,
                              srsran_mib_nr_t *mib);

SRSRAN_API uint32_t srsran_pbch_msg_info(const srsran_pbch_msg_nr_t *msg,
                                         char *str, uint32_t str_len);

SRSRAN_API uint32_t srsran_pbch_msg_nr_mib_info(const srsran_mib_nr_t *mib,
                                                char *str, uint32_t str_len);
