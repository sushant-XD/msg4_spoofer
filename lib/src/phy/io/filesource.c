...
int srsran_filesource_init(srsran_filesource_t *q, const char *filename,
...
int srsran_filesource_read_multi(srsran_filesource_t *q, void **buffer,
                                 int nsamples, int nof_channels) {
  int i, j, count = 0;
  _Complex float **cbuf = (_Complex float **)buffer;
